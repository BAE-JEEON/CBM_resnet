...
__all__ = ['MLP','ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'resnext50_32x4d', 'resnext101_32x8d',
           'wide_resnet50_2', 'wide_resnet101_2', 'End2EndModel']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, n_attributes=0, bottleneck=False, expand_dim=0, three_class=False, connect_CY=False):
        """
        Args:
...
def _resnet(arch, block, layers, pretrained, progress, freeze, **kwargs):
...
def resnet18(freeze, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, freeze, 
                   **kwargs)



def resnet34(freeze, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, freeze, 
                   **kwargs)



def resnet50(freeze, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, freeze,
                   **kwargs)



def resnet101(freeze, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress, freeze,
                   **kwargs)



def resnet152(freeze, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress, freeze,
                   **kwargs)



def resnext50_32x4d(freeze, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], 
                   pretrained, progress, freeze, **kwargs)



def resnext101_32x8d(freeze, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], freeze,
                   pretrained, progress, freeze, **kwargs)



def wide_resnet50_2(freeze, pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], freeze,
                   pretrained, progress, freeze, **kwargs)



def wide_resnet101_2(freeze, pretrained=False, progress=True, **kwargs):
